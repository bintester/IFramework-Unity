...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp2(UnityEngine.Camera p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp4(string p0, IFramework.UI.UIPanel p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp6(IFramework.UI.SuperScrollView.LoopListView p0, IFramework.UI.SuperScrollView.LoopListViewItem p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp9(string p0, bool p1, string p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(string p0, string p1, UnityEngine.LogType p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp13(UnityEngine.CullingGroupEvent p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp14(UnityEngine.ReflectionProbe p0, UnityEngine.ReflectionProbe.ReflectionProbeEvent p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp15(UnityEngine.Cubemap p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp16(UnityEngine.CustomRenderTexture p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp17(UnityEngine.CustomRenderTexture p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp18(UnityEngine.AsyncOperation p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp19(UnityEngine.RectTransform p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp20(UnityEngine.Font p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp21(bool p0, bool p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public char __Gen_Delegate_Imp22(string p0, int p1, char p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public float __Gen_Delegate_Imp23(UnityEngine.UI.ILayoutElement p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public IFramework.UI.SuperScrollView.LoopListViewItem __Gen_Delegate_Imp28(IFramework.UI.SuperScrollView.LoopListView p0, int p1)
		{
            ...
            lock (luaEnv.luaEnvLock)
            {
                ...
                IFramework.UI.SuperScrollView.LoopListViewItem __gen_ret = (IFramework.UI.SuperScrollView.LoopListViewItem)translator.GetObject(L, errFunc + 1, typeof(IFramework.UI.SuperScrollView.LoopListViewItem));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public bool __Gen_Delegate_Imp29(string p0, IFramework.UI.UIPanel p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp31(IFramework.Message.IMessage p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new UnityEngine.Camera.CameraCallback(__Gen_Delegate_Imp2);
			}
		    ...
		    if (type == typeof(System.Action<string, IFramework.UI.UIPanel>))
			{
			    return new System.Action<string, IFramework.UI.UIPanel>(__Gen_Delegate_Imp4);
			}
			...
			{
			    return new UnityEngine.Application.LowMemoryCallback(__Gen_Delegate_Imp5);
			}
			...
			{
			    return new UnityEngine.Display.DisplaysUpdatedDelegate(__Gen_Delegate_Imp5);
			}
			...
			{
			    return new UnityEngine.RemoteSettings.UpdatedEventHandler(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(System.Action<IFramework.UI.SuperScrollView.LoopListView, IFramework.UI.SuperScrollView.LoopListViewItem>))
			{
			    return new System.Action<IFramework.UI.SuperScrollView.LoopListView, IFramework.UI.SuperScrollView.LoopListViewItem>(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(UnityEngine.AudioClip.PCMReaderCallback))
			{
			    return new UnityEngine.AudioClip.PCMReaderCallback(__Gen_Delegate_Imp7);
			}
		
		    if (type == typeof(UnityEngine.AudioClip.PCMSetPositionCallback))
			{
			    return new UnityEngine.AudioClip.PCMSetPositionCallback(__Gen_Delegate_Imp8);
			}
			...
			{
			    return new UnityEngine.Application.AdvertisingIdentifierCallback(__Gen_Delegate_Imp9);
			}
		
		    if (type == typeof(UnityEngine.Application.LogCallback))
			{
			    return new UnityEngine.Application.LogCallback(__Gen_Delegate_Imp10);
			}
			...
			{
			    return new UnityEngine.CullingGroup.StateChanged(__Gen_Delegate_Imp13);
			}
		
		    if (type == typeof(System.Action<UnityEngine.ReflectionProbe, UnityEngine.ReflectionProbe.ReflectionProbeEvent>))
			{
			    return new System.Action<UnityEngine.ReflectionProbe, UnityEngine.ReflectionProbe.ReflectionProbeEvent>(__Gen_Delegate_Imp14);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Cubemap>))
			{
			    return new System.Action<UnityEngine.Cubemap>(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(System.Action<UnityEngine.CustomRenderTexture>))
			{
			    return new System.Action<UnityEngine.CustomRenderTexture>(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(System.Action<UnityEngine.CustomRenderTexture, int>))
			{
			    return new System.Action<UnityEngine.CustomRenderTexture, int>(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(System.Action<UnityEngine.AsyncOperation>))
			{
			    return new System.Action<UnityEngine.AsyncOperation>(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(UnityEngine.RectTransform.ReapplyDrivenProperties))
			{
			    return new UnityEngine.RectTransform.ReapplyDrivenProperties(__Gen_Delegate_Imp19);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Font>))
			{
			    return new System.Action<UnityEngine.Font>(__Gen_Delegate_Imp20);
			}
		
		    if (type == typeof(System.Action<bool, bool, int>))
			{
			    return new System.Action<bool, bool, int>(__Gen_Delegate_Imp21);
			}
		
		    if (type == typeof(UnityEngine.UI.InputField.OnValidateInput))
			{
			    return new UnityEngine.UI.InputField.OnValidateInput(__Gen_Delegate_Imp22);
			}
		
		    if (type == typeof(System.Func<UnityEngine.UI.ILayoutElement, float>))
			{
			    return new System.Func<UnityEngine.UI.ILayoutElement, float>(__Gen_Delegate_Imp23);
			}
		    ...
		    if (type == typeof(System.Func<string, IFramework.UI.UIPanel, bool>))
			{
			    return new System.Func<string, IFramework.UI.UIPanel, bool>(__Gen_Delegate_Imp29);
			}
			...
			{
			    return new IFramework.Message.MessageListener(__Gen_Delegate_Imp31);
			}
