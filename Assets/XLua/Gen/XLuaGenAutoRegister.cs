...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit7(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(A), AWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(IFramework.Modules), IFrameworkModulesWrap.__Register);
        ...
        static void wrapInit8(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(IFramework.UI.GameObjectView), IFrameworkUIGameObjectViewWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(IFramework.UI.UIItemOperation), IFrameworkUIUIItemOperationWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(IFramework.UI.UIModule), IFrameworkUIUIModuleWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(IFramework.UI.UIItemView), IFrameworkUIUIItemViewWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(IFramework.UI.UIItemViewCollection), IFrameworkUIUIItemViewCollectionWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(IFramework.UI.UIObjectView), IFrameworkUIUIObjectViewWrap.__Register);
        ...
        static void wrapInit9(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(IFramework.UI.UIEx.UIItemViewAwaiter), IFrameworkUIUIExUIItemViewAwaiterWrap.__Register);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate void __GEN_DELEGATE2( System.Action action,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE3( System.Action action,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE4( System.Action action,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE5( System.Action action,  IFramework.IEnvironment env);
		
		delegate void __GEN_DELEGATE6( System.Action action,  IFramework.EnvironmentType envType);
		
		delegate void __GEN_DELEGATE7( System.Action action,  IFramework.EnvironmentType envType);
		
		delegate void __GEN_DELEGATE8( System.Action action,  IFramework.EnvironmentType envType);
		
		delegate void __GEN_DELEGATE9( System.Action action,  IFramework.EnvironmentType envType);
		
		delegate string __GEN_DELEGATE10( string path,  string toCombinePath);
		
		delegate string __GEN_DELEGATE11( string path);
		
		delegate System.Collections.Generic.IEnumerable<System.Type> __GEN_DELEGATE12( System.Type self);
		
		delegate System.Collections.Generic.IEnumerable<System.Type> __GEN_DELEGATE13( System.Type self);
		
		delegate string __GEN_DELEGATE14( string self);
		
		delegate string __GEN_DELEGATE15( string self);
		
		delegate string __GEN_DELEGATE16( string self);
		
		delegate IFramework.IAwaiter __GEN_DELEGATE17( IFramework.Hotfix.Lua.ILuaTask target);
		
		delegate IFramework.Recorder.CommandState __GEN_DELEGATE18( IFramework.Recorder.IOperationRecorderModule t);
		
		delegate IFramework.Recorder.ActionState __GEN_DELEGATE19( IFramework.Recorder.IOperationRecorderModule t);
		
		delegate IFramework.Recorder.CommandGroupState __GEN_DELEGATE20( IFramework.Recorder.IOperationRecorderModule t);
		
		delegate IFramework.Recorder.ActionGroupState __GEN_DELEGATE21( IFramework.Recorder.IOperationRecorderModule t);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(System.Action), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE2(IFramework.Framework.BindEnvUpdate)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE3(IFramework.Framework.UnBindEnvUpdate)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE4(IFramework.Framework.BindEnvDispose)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE5(IFramework.Framework.UnBindEnvDispose)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE6(IFramework.Framework.BindEnvUpdate)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE7(IFramework.Framework.UnBindEnvUpdate)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE8(IFramework.Framework.BindEnvDispose)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE9(IFramework.Framework.UnBindEnvDispose)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(string), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE10(IFramework.Ex.CombinePath)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE11(IFramework.Ex.ToRegularPath)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE14(IFramework.Ex.ToUnixLineEndings)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE15(IFramework.UnityEx.ToAbsPath)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE16(IFramework.UnityEx.ToAssetsPath)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(System.Type), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE12(IFramework.Ex.GetSubTypesInAssembly)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE13(IFramework.Ex.GetSubTypesInAssemblys)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(IFramework.Hotfix.Lua.ILuaTask), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE17(IFramework.Hotfix.Lua.LuaEX.GetAwaiter)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(IFramework.Recorder.IOperationRecorderModule), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE18(IFramework.Recorder.OperationRecorderEx.AllocateCommand)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE19(IFramework.Recorder.OperationRecorderEx.AllocateAction)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE20(IFramework.Recorder.OperationRecorderEx.AllocateCommandGroup)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE21(IFramework.Recorder.OperationRecorderEx.AllocateActionGroup)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
