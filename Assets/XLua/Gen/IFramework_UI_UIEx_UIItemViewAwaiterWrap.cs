...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkUIUIExUIItemViewAwaiterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.UI.UIEx.UIItemViewAwaiter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<IFramework.UI.UIItemView>(L, 2))
				{
					IFramework.UI.UIItemView _task = (IFramework.UI.UIItemView)translator.GetObject(L, 2, typeof(IFramework.UI.UIItemView));
					
					var gen_ret = new IFramework.UI.UIEx.UIItemViewAwaiter(_task);
				...
				{
				    translator.Push(L, default(IFramework.UI.UIEx.UIItemViewAwaiter));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.UI.UIEx.UIItemViewAwaiter constructor!");
        ...
        static int _m_GetResult(RealStatePtr L)
        {
		    try {
                ...
                IFramework.UI.UIEx.UIItemViewAwaiter gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
