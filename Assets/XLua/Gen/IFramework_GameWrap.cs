...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkGameWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Game);
        ...
        {
            return LuaAPI.luaL_error(L, "IFramework.Game does not have a constructor!");
        }
        ...
        static int _m_Init(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Game gen_to_be_invoked = (IFramework.Game)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_modules(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Game gen_to_be_invoked = (IFramework.Game)translator.FastGetCSObj(L, 1);
                translator.PushAny(L, gen_to_be_invoked.modules);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
