...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkUIUIModuleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ShowRaycast", _m_ShowRaycast);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "HideRayCast", _m_HideRayCast);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new IFramework.UI.UIModule();
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetItem( _path );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetItem(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<IFramework.UI.UIItemOperation>(L, 3)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                    IFramework.UI.UIItemOperation _go = (IFramework.UI.UIItemOperation)translator.GetObject(L, 3, typeof(IFramework.UI.UIItemOperation));
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ShowRaycast(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_HideRayCast(RealStatePtr L)
        {
		    try {
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.Show( _path );
                        translator.Push(L, gen_ret);
