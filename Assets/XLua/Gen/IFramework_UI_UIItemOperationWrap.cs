...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkUIUIItemOperationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.UI.UIItemOperation);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<IFramework.UI.UIModule.ItemPool>(L, 2))
				{
					...
					var gen_ret = new IFramework.UI.UIItemOperation(_pool);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.UI.UIItemOperation constructor!");
        ...
        static int _m_GetAwaiter(RealStatePtr L)
        {
		    try {
                ...
                IFramework.UI.UIItemOperation gen_to_be_invoked = (IFramework.UI.UIItemOperation)translator.FastGetCSObj(L, 1);
