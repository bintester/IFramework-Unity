...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkLauncherWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "BindUpdate", _m_BindUpdate_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "UnBindUpdate", _m_UnBindUpdate_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "BindDisable", _m_BindDisable_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "UnBindDisable", _m_UnBindDisable_xlua_st_);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new IFramework.Launcher();
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_BindUpdate_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    IFramework.Launcher.BindUpdate( _action );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_UnBindUpdate_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    IFramework.Launcher.UnBindUpdate( _action );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_BindDisable_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    IFramework.Launcher.BindDisable( _action );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_UnBindDisable_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    IFramework.Launcher.UnBindDisable( _action );
